...
public record SharedGroupSummaryResponse(
        @Schema(description = "공유 그룹 식별자", example = "b8a5f612-25d7-4ec3-9d1d-59684de40664") UUID id,
        ...
        @Schema(description = "요청자의 그룹 참여 시각(UTC ISO-8601)", example = "2026-07-03T10:15:30Z") Instant joinedAt,
        @Schema(description = "공유 그룹 마지막 수정 시각(UTC ISO-8601)", example = "2026-07-03T10:15:30Z") Instant updatedAt) {}
