...
public record SharedGroupJoinResponse(
        @Schema(description = "참여한 공유 그룹 식별자", example = "b8a5f612-25d7-4ec3-9d1d-59684de40664") UUID sharedGroupId,
        ...
        @Schema(description = "멤버십 생성 시각(UTC ISO-8601)", example = "2026-07-03T10:15:30Z") Instant joinedAt) {}
