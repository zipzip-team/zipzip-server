...
public enum AuthErrorCode implements ErrorCode {
    ...
    INVALID_APPLE_TOKEN(HttpStatus.UNAUTHORIZED, "INVALID_APPLE_TOKEN", "Apple identity token이 올바르지 않습니다."),
    INVALID_APPLE_AUTHORIZATION_CODE(
            HttpStatus.UNAUTHORIZED, "INVALID_APPLE_AUTHORIZATION_CODE", "Apple authorization code가 올바르지 않습니다.");
